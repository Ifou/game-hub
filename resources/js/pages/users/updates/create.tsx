...
export default function UserUpdatesCreate({ profileUser, userGames, auth }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('users.updates.store', profileUser.id));
    };

    return (
        <AppLayout>
            <Head title={`New Update - ${profileUser.name}'s Updates`} />
                ...
                <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6">
                        <nav className="flex space-x-2 text-sm text-gray-500">
                            ...
                            <span>/</span>
                            <span className="text-gray-900">New Update</span>
                        </nav>
                    </div>
